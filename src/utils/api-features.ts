...
export class APIFeatures {
  query: AnyObjectType;
  queryString: AnyObjectType;

  constructor(query: AnyObjectType, queryString: AnyObjectType) {
    this.query = query;
  ...
  paginate() {
    let page = parseInt(this.queryString.page as string, 10) || 1;
    let limit = parseInt(this.queryString.limit as string, 10) || 20;
